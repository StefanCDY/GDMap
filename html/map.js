...
var roadNet = new AMap.TileLayer.RoadNet();// 路网图层类
...
var marker = new AMap.Marker();// 点标记
var infoWindow = new AMap.InfoWindow();// 信息窗体
var autoMarker = new AMap.Marker();// 提示匹配时的点标记

var citycode = null;// 所在城市的citycode
var local = {};// 当前定位位置
var position = {};// 鼠标所在位置
var address = null;// 鼠标所在详细位置
...
map.plugin(["AMap.Scale", "AMap.ToolBar", "AMap.Geolocation"],function(){
    ...
    geolocation = new AMap.Geolocation({
        ...
        panToLocation: true,// 定位成功后，是否把定位得到的坐标设置为地图中心点坐标,默认值：true
...
AMap.service(["AMap.CitySearch", "AMap.PlaceSearch", "AMap.Autocomplete", "AMap.Geocoder", "AMap.Driving", "AMap.Walking", "AMap.Transfer"], function() {
    ...
    geocoder = new AMap.Geocoder({
    	...
    	// radius:// 逆地理编码时，以给定坐标为中心点，单位：米,取值范围：0-3000,默认值：1000
    	// extensions:// 逆地理编码时，返回信息详略,默认值：base，返回基本地址信息；取值为：all，返回地址信息及附近poi、道路、道路交叉口等信息
    });
...
AMap.event.addListener(map, "rightclick", getPosition);